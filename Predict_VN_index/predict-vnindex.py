...
# Doc du lieu VCB 2000->2018
dataset_train = pd.read_csv('VNINDEX.csv')
...
dataset_test = pd.read_csv('VNINDEX-2019.csv')
...
plt.plot(real_stock_price, color = 'red', label = 'Real VNINDEX Stock Price')
plt.plot(predicted_stock_price, color = 'blue', label = 'Predicted VNINDEX Stock Price')
...
while i<28:
    ...
    print('Stock price ' + str(i+3) + '/3/2020 of VNINDEX : ', predicted_stock_price[0][0])
    i = i +1
